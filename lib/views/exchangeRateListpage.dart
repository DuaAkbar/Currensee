...
import '../controllers/exchangeRateList_controller.dart';

class Exchangeratelistpage extends StatefulWidget {
  @override
  State<Exchangeratelistpage> createState() => _ExchangeratelistpageState();
}

class _ExchangeratelistpageState extends State<Exchangeratelistpage> {
  final ExchangeratelistController controller = Get.put(
    ExchangeratelistController(),
  );
